...
const ARTWORK_STYLE_GUIDANCE = {
  ...
  'origami':        'The entire scene built from folded ORIGAMI paper. Every character and object is a crisp paper sculpture with sharp geometric creases, visible fold lines and flat angular facets, made of textured origami paper with a subtle grain. Clean solid colors, layered folded forms casting soft realistic shadows on a paper backdrop. Precise, elegant and handcrafted — recognizable characters cleverly formed from folded paper, like a beautiful papercraft diorama photographed under gentle light. NOT drawn or painted — actual folded paper',
